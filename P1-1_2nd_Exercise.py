...
if H > Ld:
    if Ld > Ln:
        ...
        if h == 0 and m == 0 and s == 0:
            ...
            print('El caracol saldrá del pozo en {} {} con {} {}.'.format(d, wd(d), s, ws(s)))
        elif s == 0 and m == 0:
            print('El caracol saldrá del pozo en {} {} con {} {}.'.format(d, wd(d), h, wh(h)))
        elif h == 0 and s == 0:
            print('El caracol saldrá del pozo en {} {} con {} {}.'.format(d, wd(d), m, wm(m)))
        elif h == 0:
